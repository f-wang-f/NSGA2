...
if __name__ == '__main__':
    ...
    for gen in range(MAX_GEN):
        ...
        if gen + 1 < MAX_GEN:  # 不在最后一代打印summary
    ...
    for i in range(final_pareto['num_solutions']):
        ...
        print(
            f' 设置参数: batch_size={batch_size_i}, learning_rate={learn_rate_i:.6f}, optimizer={opt_type_i}, regularizer={reg_type_i}')
    ...
    # 定义要绘制的目标代数
    target_generations = [1, 5, 10, 20, 40, 50]
    # 创建图形
